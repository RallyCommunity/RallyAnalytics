...
#      @scopeDataSet = true
    ...
    @config.lumenizeCalculatorConfig.startOn = new Time(@config.scopeData.StartDate)
      .getISOStringInTZ(@config.lumenizeCalculatorConfig.tz)
    @config.lumenizeCalculatorConfig.endBefore = new Time(@config.scopeData.EndDate)
#      .addInPlace(1, @config.lumenizeCalculatorConfig.granularity)
      .getISOStringInTZ(@config.lumenizeCalculatorConfig.tz)
