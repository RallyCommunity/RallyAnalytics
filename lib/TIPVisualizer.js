    ...
    */
    ...
    TIPVisualizer.prototype.initialize = function() {
      ...
      if (this.config.asOf != null) {
        this.asOfISOString = new lumenize.Time(this.config.asOf, 'millisecond').getISOStringInTZ(this.config.lumenizeCalculatorConfig.tz);
      } else {
        this.asOfISOString = null;
      }
    ...
    TIPVisualizer.prototype.createOrUpdateVisualization = function() {
