    ...
    TIPVisualizer.prototype.updateVisualizationData = function() {
      ...
      calculatorResults = (function() {
        ...
        for (_i = 0, _len = calculatorResults.length; _i < _len; _i++) {
          r = calculatorResults[_i];
          if (_ref = r.ObjectID, __indexOf.call(this.currentObjectIDs, _ref) >= 0) {
            _results.push(r);
          }
        }
        return _results;
