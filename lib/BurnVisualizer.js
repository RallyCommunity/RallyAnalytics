  ...
  BurnVisualizer = (function(_super) {
    ...
    */
    ...
    BurnVisualizer.prototype.initialize = function() {
      ...
      if ((typeof Rally !== "undefined" && Rally !== null ? Rally.environment : void 0) != null) {
        Rally.environment.getMessageBus().subscribe("timeBoxScopeChange", function(a) {
          var data, record;
          record = a.getRecord();
          data = record.data;
          return console.log('in BurnVisualizer.initialize', data.StartDate, data.EndDate, data.Name);
        });
      } else {
    ...
    BurnVisualizer.prototype.onNewDataAvailable = function() {
      ...
      this.analyticsQuery.leafOnly().fields(fields).hydrate(['ScheduleState']);
