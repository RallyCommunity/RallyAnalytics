  ...
  BurnVisualizer = (function(_super) {
    ...
    */
    ...
    BurnVisualizer.prototype.initialize = function() {
      ...
      this.config.lumenizeCalculatorConfig.startOn = new Time(this.config.scopeData.StartDate).getISOStringInTZ(this.config.lumenizeCalculatorConfig.tz);
      this.config.lumenizeCalculatorConfig.endBefore = new Time(this.config.scopeData.EndDate).getISOStringInTZ(this.config.lumenizeCalculatorConfig.tz);
