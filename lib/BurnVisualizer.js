...
(function() {
  var BurnVisualizer, lumenize, utils,
  ...
  BurnVisualizer = (function(_super) {
    ...
    */
    ...
    BurnVisualizer.prototype.onNewDataAvailable = function() {
      ...
      this.analyticsQuery.type('HierarchicalRequirement').leafOnly().fields(fields).hydrate(['ScheduleState']);
    ...
    BurnVisualizer.prototype.updateVisualizationData = function() {
      var calculatorResults, categories, row, series;
      if (this.config.trace) {
      ...
      series = lumenize.aggregationAtArray_To_HighChartsSeries(calculatorResults.seriesData, this.config.chartSeries);
      categories = (function() {
        var _i, _len, _ref, _results;
        _ref = calculatorResults.seriesData;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          row = _ref[_i];
          _results.push(row.tick);
        }
        return _results;
      })();
