  ...
  BurnVisualizer = (function(_super) {
    ...
    */
    ...
    BurnVisualizer.prototype.initialize = function() {
      ...
      this.config.lumenizeCalculatorConfig.startOn = new Time(this.userConfig.scopeData.StartDate).addInPlace(1, Time.DAY).getISOStringInTZ(this.config.lumenizeCalculatorConfig.tz);
    ...
    BurnVisualizer.prototype.updateVisualizationData = function() {
      ...
      categories = (function() {
        ...
        for (_j = 0, _len1 = seriesData.length; _j < _len1; _j++) {
          row = seriesData[_j];
          _results.push(new Time(row.tick, this.config.granularity, this.config.lumenizeCalculatorConfig.tz).addInPlace(1, Time.DAY).toString());
        }
        return _results;
      }).call(this);
