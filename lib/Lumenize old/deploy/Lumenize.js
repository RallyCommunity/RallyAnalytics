...
require.define("/lumenize.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
...
require.define("/src/utils.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var AssertException, ErrorBase, StopIteration, assert, clone, isArray, match, startsWith, trim, type,
...
require.define("/src/dataTransform.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  ...
  snapshotArray_To_AtArray = function(snapshotArray, listOfAtCTs, validFromField, uniqueIDField, tz, validToField) {
    ...
    */
    ...
    var atCT, atLength, atPointer, atRow, atValue, currentAtCT, currentRow, currentSnapshot, currentSnapshotCT, d, granularity, index, key, output, outputRow, preOutput, snapshotLength, snapshotPointer, toDelete, uniqueID, validToCT, value, _i, _j, _k, _len, _len1, _len2;
    ...
    output = [];
    for (_k = 0, _len2 = preOutput.length; _k < _len2; _k++) {
      atRow = preOutput[_k];
      outputRow = [];
      for (key in atRow) {
        value = atRow[key];
  ...
  groupByAtArray_To_HighChartsSeries = function(groupByAtArray, nameField, valueField, nameFieldValues, returnPreOutput) {
    ...
    */
    ...
    if ((returnPreOutput != null) && returnPreOutput) {
      return preOutput;
    }
    output = [];
    ...
    */
    ...
    for (_i = 0, _len = list.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        ...
        _results1 = [];
        for (_j = 0, _len1 = derivedFields.length; _j < _len1; _j++) {
          d = derivedFields[_j];
