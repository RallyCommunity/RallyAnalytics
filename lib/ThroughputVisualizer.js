  ...
  ThroughputVisualizer = (function(_super) {
    ...
    */
    ...
    ThroughputVisualizer.prototype.onNewDataAvailable = function() {
      ...
      this.analyticsQuery = new TransitionsAnalyticsQuery(queryConfig, this.upToDate, this.config.transitionsPredicate);
      this.analyticsQueryToSubtract = new TransitionsAnalyticsQuery(queryConfig, this.upToDate, this.config.transitionsToSubtractPredicate);
    ...
    ThroughputVisualizer.prototype._gotSnapshotsToSubtract = function(snapshotsToSubtract, startOn, endBefore) {
    ...
    ThroughputVisualizer.prototype.onSnapshotsReceieved = function(snapshots, startOn, endBefore, queryInstance, snapshotsToSubtract) {
      ...
      if (!((this.config.asOf != null) && this.upToDate < this.config.asOf)) {
        if (this.analyticsQuery.hasMorePages() || this.analyticsQueryToSubtract.hasMorePages()) {
          ...
          if (this.analyticsQueryToSubtract.hasMorePages()) {
            this.gotSnapshotsToSubtract = false;
            return this.analyticsQueryToSubtract.getPage(this._gotSnapshotsToSubtract);
          }
        } else {
    ...
    ThroughputVisualizer.prototype.createOrUpdateVisualization = function() {
      var calculatorResults, categories, data, f, highestTimePeriod, highestTimeString, index, lowestTimePeriod, row, series, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
      ...
      if (this.config.asOf != null) {
        highestTimeString = this.asOfISOString;
      } else {
