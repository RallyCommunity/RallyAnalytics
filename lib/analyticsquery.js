...
(function() {
  var AnalyticsQuery, AtAnalyticsQuery, AtArrayAnalyticsQuery, BetweenAnalyticsQuery, GuidedAnalyticsQuery, Time, TimeInStateAnalyticsQuery, TransitionsAnalyticsQuery, lumenize, root, utils,
  ...
  AnalyticsQuery = (function() {
    ...
    */
    ...
    AnalyticsQuery.prototype._gotResponse = function() {
      var endBefore, key, newFind, o, results, startOn, value, _i, _len, _ref;
      if (this._debug) {
      ...
      if (this._xhr.readyState === 4) {
        ...
        if (this.lastResponse.Errors.length > 0) {
          ...
          if (this.lastResponse.Results.length + this.lastResponse.StartIndex >= this.lastResponse.TotalResultCount) {
            ...
            endBefore = this.ETLDate;
          } else {
            this._hasMorePages = true;
            this._startIndex += this._pageSize;
            endBefore = this.lastPageResults[this.lastPageResults.length - 1]._ValidFrom;
          }
          ...
          return this._callback(this.lastPageResults, startOn, endBefore, this);
        }
      }
    };
  ...
  AtArrayAnalyticsQuery = (function(_super) {
    ...
    */
    ...
    function AtArrayAnalyticsQuery(config, upToDate, arrayOfZuluDates) {
      AtArrayAnalyticsQuery.__super__.constructor.call(this, config, upToDate);
