...
(function() {
  ...
  cfdCalculator = function(results, config) {
    ...
    */
    ...
    var categories, ct, drillDownObjectIDs, firstTrackingCT, firstTrackingDate, groupByAtArray, i, lastTrackingCT, lastTrackingDate, listOfAtCTs, lowestValueInLastState, maxDaysBackCT, rangeSpec, row, series, timeSeriesGroupByCalculatorConfig, uniqueValues, _i, _len, _ref;
    ...
    console.log('RangeSpec:\n' + JSON.stringify(rangeSpec, void 0, 4));
