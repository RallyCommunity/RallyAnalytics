    ...
    */
    ...
    VisualizerBase.prototype.initialize = function() {
      ...
      if (this.userConfig.tz != null) {
        this.config.lumenizeCalculatorConfig.tz = this.userConfig.tz;
      } else {
        this.config.tz = this.workspaceConfiguration.TimeZone;
        this.config.lumenizeCalculatorConfig.tz = this.workspaceConfiguration.TimeZone;
      }
      if (this.config.asOf != null) {
        return this.asOfISOString = new lumenize.Time(this.config.asOf, 'millisecond').getISOStringInTZ(this.config.lumenizeCalculatorConfig.tz);
      } else {
        return this.asOfISOString = null;
      }
    };
